...
begin
    ...
    begin
      try
        ...
        ID_Consulta := DM.QueryPediatra.FieldByName('id_consulta').AsInteger;
...
procedure TformAgendaPed.edtPesquisaChange(Sender: TObject);
begin
  DM.QueryPediatra.Locate('nome', edtPesquisa.Text, [loPartialKey, loCaseInsensitive]);
end;
